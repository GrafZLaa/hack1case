...
def extract():
    ...
    try:
        ...
        run_ocr = provider != "openai" or USE_OCR_WITH_OPENAI or provider == "disabled"
...
def meta():
    ...
    return jsonify({
        ...
        "model_candidates": MODEL_CANDIDATES if provider == "ollama" else ([OPENAI_MODEL] if provider == "openai" else []),
